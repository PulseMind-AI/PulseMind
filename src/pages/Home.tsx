...
// Add type for window.VANTA to avoid TypeScript warnings
declare global {
  interface Window {
    VANTA: {
  ...
  useEffect(() => {
    ...
    if (window.VANTA) {
      window.VANTA.BIRDS({
        ...
        color2: 0x00bfff, // Deep sky blue for variation
        birdSize: 1.2,
        wingSpan: 25.00,
        speedLimit: 3.00,
        separation: 20.00,
  ...
  return (
    <div className="min-h-screen bg-stress-dark">
      ...
      <div className="absolute inset-0 z-1 opacity-30 pointer-events-none" style={{
        background: `
          radial-gradient(ellipse 800px 300px at 400px 300px, rgba(255, 255, 255, 0.3), transparent 50%),
          radial-gradient(ellipse 600px 200px at 800px 100px, rgba(255, 255, 255, 0.2), transparent 50%),
          radial-gradient(ellipse 700px 250px at 200px 150px, rgba(255, 255, 255, 0.25), transparent 50%),
          radial-gradient(ellipse 500px 180px at 600px 400px, rgba(255, 255, 255, 0.2), transparent 50%),
          radial-gradient(ellipse 400px 150px at 1000px 200px, rgba(255, 255, 255, 0.3), transparent 50%)
        `
      }}></div>
        ...
        <div className="z-10 container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="max-w-2xl">
            <h1 className="text-6xl font-bold mb-6 text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
              Welcome to
              <span className="text-stress-yellow drop-shadow-[0_2px_4px_rgba(0,0,0,0.7)]"> PulseMind</span>
            </h1>
            ...
            <div className="flex space-x-4">
              ...
              >
                ...
                <span>Talk to PulseMind AI</span>
              </Link>
              <Link 
                to="/recommendations"
                className="flex items-center space-x-2 bg-stress-dark border-2 border-stress-yellow text-stress-yellow px-8 py-3 rounded-full hover:bg-stress-yellow hover:text-stress-dark transition-all drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]"
          ...
          {/* Right side - MindWaves image */}
          <div className="hidden lg:block w-1/2">
            <img 
              src="/MindWaves.png"
              alt="Mind Waves - Mental wellness visualization"
              className="rounded-2xl shadow-2xl drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)] w-full h-auto object-cover"
            />
          </div>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              At PulseMind AI, we believe that true well-being comes from a balance of mind, body, and soul. Our approach blends ancient wisdom with modern science, offering you a personalized path to inner peace and mental clarity.
              </p>
              <p className="text-gray-300 mb-6">
      ...
      <footer className="bg-gray-700 py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4"><span className="text-stress-yellow">PulseMind AI</span></h3>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} PulseMind AI. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
